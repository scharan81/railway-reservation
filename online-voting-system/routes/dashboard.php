    ...
    <body>
            ...
            <div id="mainSection">
                <div id="profileSection">
                    ...
                    <b>Aadhar Number : </b><?php echo $data['aadhar'] ?><br><br>
                        ...
                        for($i=0; $i<count($groups); $i++){
                            ?>
                                ...
                                if($_SESSION['status']==1){
                                    ...
                                    ?>
                                    <button style="padding: 5px; font-size: 15px; background-color: #3498db; color: white; border-radius: 5px; cursor:pointer" type="submit">Vote</button>
                                    <?php
                                }
                                ?>
                                </form>

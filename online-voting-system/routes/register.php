        ...
        <center>
            ...
            <h2>Registration</h2>
                <form action="../api/register.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input style="width: 21%" type="number" name="aadhar" placeholder="Aadhar Number" required><br><br>
                    <input style="width: 21%" type="email" name="email" placeholder="e-mail" required><br><br>
                    ...
                    <button id="loginbtn" style= "cursor:pointer" type="submit" name="registerbtn">Register</button><br><br>

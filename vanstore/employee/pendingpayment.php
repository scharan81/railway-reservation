            ...
            <ul class="navbar-nav mx-auto h-100">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item active" href="pendingpayment.php">Pending payment</a>
    ...
    <div style="margin-left: 50px;margin-right: 50px;">
          <div class="items" style="margin: auto;background-color:#435c70;">
              <table class="table" style="background-color: #3C4043;">
                ...
                <tr><th>ORDER_ID</th><th>CUSTOMERID</th><th>PHONE</th><th>ITEMS</th><th>ADDRESS</th><th>TOTALPAYMENT</th></tr>
                </thead>
                <tbody style="text-align: center;">
                  ...
                  $res=mysqli_query($conn,"select * from sales where paystat='COD'");
